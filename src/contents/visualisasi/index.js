export const groupBarChart1 = [
  ...
  {
    title:
      "Jumlah Pemilih Baru Berdasarkan Jenis Kelamin dan Kota di Provinsi DKI Jakarta",
    interpretasi:
      "Data mengenai jumlah pemilih tetap berdasarkan jenis kelamin dan kota di Provinsi DKI Jakarta menunjukkan variasi yang signifikan. Di Jakarta Barat, pemilih laki-laki berjumlah 427, sementara perempuan hanya 258, menunjukkan dominasi laki-laki. Hal serupa terlihat di Jakarta Utara dengan laki-laki 357 dan perempuan 257, serta di Kepulauan Seribu dengan laki-laki 341 dan perempuan 269. Namun, di Jakarta Selatan dan Jakarta Timur, jumlah pemilih perempuan sedikit lebih tinggi dengan masing-masing 339 perempuan dibandingkan 402 laki-laki di Jakarta Selatan, dan 426 perempuan dibandingkan 361 laki-laki di Jakarta Timur. Di Jakarta Pusat, jumlah pemilih hampir seimbang dengan 356 laki-laki dan 350 perempuan. Secara keseluruhan, data ini menunjukkan variasi yang cukup beragam dengan beberapa wilayah mendominasi oleh pemilih laki-laki sementara yang lain menunjukkan keseimbangan atau dominasi perempuan.",
    label: ["Laki-Laki", "Perempuan"],
    warna: ["#FFBF00", "#FFDC73"],
  ...
  {
    title:
      "Pemilih Tidak Tetap Berdasarkan Jenis Kelamin dan Kota di Provinsi DKI Jakarta",
    interpretasi:
...
export const groupBarChart2 = [
  { region: "Jakarta Barat", male: 32.7, female: 37.8 },
  { region: "Jakarta Selatan", male: 41.2, female: 30.9 },
  { region: "Jakarta Timur", male: 29.1, female: 22.6 },
  { region: "Jakarta Utara", male: 31.7, female: 35.7 },
  { region: "Jakarta Pusat", male: 28.6, female: 25.0 },
  { region: "Kepulauan Seribu", male: 39.1, female: 36.9 },
];

export const spiderChart1 = [
  [
    // Orang Tua
    { axis: "Langsung", value: 0.725, group: 0 },
    { axis: "Umum", value: 0.291, group: 0 },
    { axis: "Bersih", value: 0.697, group: 0 },
    { axis: "Rahasia", value: 0.038, group: 0 },
    { axis: "Jujur", value: 0.5, group: 0 },
    { axis: "Adil", value: 0.03, group: 0 },
  ],
  [
    // Gen Z Anak
    { axis: "Langsung", value: 0.581, group: 1 },
    { axis: "Umum", value: 0.163, group: 1 },
    { axis: "Bersih", value: 0.418, group: 1 },
    { axis: "Rahasia", value: 0.1, group: 1 },
    { axis: "Jujur", value: 0.5, group: 1 },
    { axis: "Adil", value: 0.054, group: 1 },
  ],
  [
    // Gen Z Dewasa
    { axis: "Langsung", value: 0.481, group: 2 },
    { axis: "Umum", value: 0.363, group: 2 },
    { axis: "Bersih", value: 0.718, group: 2 },
    { axis: "Rahasia", value: 0.2, group: 2 },
    { axis: "Jujur", value: 0.35, group: 2 },
    { axis: "Adil", value: 0.194, group: 2 },
  ],
];
