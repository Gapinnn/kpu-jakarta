            ...
            >
              <li>
                <p>
                  ...
                  Pejabat PPID di Lingkungan Sekretariat KPU Provinsi DKI
                  Jakarta paling lambat 30 (tiga puluh) hari kerja setelah
                ...
                <ol className="flex flex-col gap-1 pl-6 list-disc text-sm md:text-base lg:text-lg">
                  ...
                  <li>
                    ketidaksesuaian antara program kerja yang dilaksanakan
                    dengan yang telah direncanakan;
                  </li>
                  <li>
                    tidak ditanggapinya laporan atau aduan terkait program
                    kerja;
                  </li>
                  <li>
        ...
        {activeStep === 2 && (
          <div className="w-full px-5 md:px-8 pr-3 lg:pr-0 lg:px-16 py-4">
            ...
            >
              <li>
                <p>
                  Laporan aduan masyarakat akan ditindaklanjuti oleh Pejabat
                  PPID di Lingkungan Sekretariat KPU Provinsi DKI Jakarta paling
                  lambat 30 (tiga puluh) hari kerja setelah laporan aduan
                  masyarakay diterima
                </p>
              </li>
              <li>
