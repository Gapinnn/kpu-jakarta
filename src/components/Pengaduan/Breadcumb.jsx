  ...
  return (
    <nav className="inline align-middle mb-4" aria-label="Breadcrumb">
      ...
      >
        ...
        <span className="inline text-center align-text-top">{lang === "id" ? "Beranda" : "Home"}</span>
      </Link>
      {/* Halaman Saat Ini */}
      <Link className="text-sm md:text-base lg:text-lg inline font-semibold text-stone-900 align-middle">
        ...
        <span className="inline text-center align-text-top">{lang === "id" ? "Pengaduan" : "Complaint"}</span>
      </Link>
    </nav>
  );
}
