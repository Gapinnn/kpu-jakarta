      ...
      <div className="p-2 bg-white shadow-md rounded-lg flex flex-row gap-2">
        <div className="flex md:w-1/4 relative">
          ...
          <div className="w-fit bg-maroon-light absolute bottom-0 left-0 rounded-r-md rounded-bl-md">
            <p className="text-gold text-sm px-2 py-1 rounded-lg">MODUL</p>
          </div>
        </div>
  ...
  return (
    <div className="flex flex-col bg-stone-100 rounded-2xl">
      <div className="py-4 flex flex-col gap-1">
        <h1 className="text-maroon-light text-2xl font-bold">Modul</h1>
        <p className="text-stone-900 text-lg">
          Publikasi ini berisi modul-modul yang dirancang oleh KPU DKI Jakarta
          sebagai materi pembelajaran dan pelatihan untuk pemilih, petugas
          pemilu, dan pihak terkait lainnya, dengan tujuan meningkatkan
          pemahaman tentang proses pemilu.
        </p>
      </div>
