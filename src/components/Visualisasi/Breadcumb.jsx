  ...
  return (
    ...
    >
      <ol className="inline-flex items-center space-x-1 rtl:space-x-reverse">
        ...
        <Link to={`/${lang}/statistik/visualisasi`}>
          <div className="flex items-center">
            ...
            <p className="text-lg text-maroon-light font-medium">Statistik</p>
          </div>
        </Link>
        {/* Current Page */}
        <Link>
          <div className="flex items-center">
            ...
            <p className="text-lg text-gray-900 font-medium">Visualisasi</p>
          </div>
        </Link>
      </ol>
    </nav>
